...
class PatientBase(models.Model):
    ...
    pesnum = models.CharField(max_length=20, null=True, blank=True)
    age = models.IntegerField(null=True, blank=True)
    patheight = models.CharField(max_length=50, null=True, blank=True)
    patweight = models.CharField(max_length=50, null=True, blank=True)
...
class PatientProfile(models.Model):
    ...
    top_diameter = models.CharField(max_length=20, null=True, blank=True)
    ...
    albuminy = models.CharField(max_length=5, null=True, blank=True) # norma 3,5-5
